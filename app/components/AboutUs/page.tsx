...
export default function AboutUs() {
  const features = [
    ...
    { icon: Calendar, title: "Perfect\nPlanning" },
    { icon: Award, title: "Trusted &\nReliable" },
  ];
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center">
          ...
          >
            <motion.h4 variants={slideRightVariants} className="text-[#be29ab] font-extrabold tracking-[0.15em] text-[11px] sm:text-[13px] mb-3 sm:mb-4 flex items-center gap-2 sm:gap-3 uppercase">
              ABOUT US <span className="w-8 sm:w-12 h-[2px] bg-gradient-to-r from-[#be29ab] to-[#5129ea] inline-block"></span>
            ...
            <motion.p variants={fadeUpVariants} className="text-[#374151] mb-6 sm:mb-10 max-w-[480px] leading-relaxed text-[15px] sm:text-[16px] font-medium">
              Eventora is a full-service event management company dedicated to delivering exceptional events that inspire, engage, and create lasting memories.
            </motion.p>
            ...
            <div className="hidden lg:flex sm:justify-start justify-center mt-2">
              <motion.button variants={fadeUpVariants} className="group cursor-pointer bg-gradient-to-r from-[#be29ab] to-[#5129ea] text-white pl-8 pr-2.5 py-2.5 rounded-full font-bold hover:shadow-[0_10px_30px_rgba(81,41,234,0.5)] transition-all flex items-center gap-5 shadow-[0_8px_25px_rgba(81,41,234,0.35)]">
                <span className="text-[15px] tracking-wide">Explore More About Us</span>
          ...
          >
            <div className="grid grid-cols-2 gap-3 relative">
              <div className="relative aspect-square rounded-2xl overflow-hidden shadow-lg">
                <img src="/images/about/a1.png" alt="Outdoor setup" className="w-full h-full object-cover" />
              </div>
              <div className="relative aspect-square rounded-2xl overflow-hidden shadow-lg">
                <img src="/images/about/a2.png" alt="Blue lighting event" className="w-full h-full object-cover" />
              </div>
              <div className="relative aspect-square rounded-2xl overflow-hidden shadow-lg">
                <img src="/images/about/a3.png" alt="Purple lighting event" className="w-full h-full object-cover" />
              </div>
              <div className="relative aspect-square rounded-2xl overflow-hidden shadow-lg">
                <img src="/images/about/a4.png" alt="Walkway setup" className="w-full h-full object-cover" />
              </div>
              ...
              >
                ...
                <span className="text-4xl md:text-5xl font-bold mb-1">8+</span>
                <span className="text-[11px] md:text-[13px] font-medium text-center leading-tight">Years of<br/>Experience</span>
              </motion.div>
            </div>
          </motion.div>
