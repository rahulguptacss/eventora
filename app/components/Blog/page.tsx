...
export default function Blog() {
  const blogs = [
    {
      id: 1,
      title: "Top 10 Wedding Trends to Watch in 2024",
      tag: "Wedding",
      date: "12 May, 2024",
    ...
    {
      id: 2,
      title: "How to Plan a Stress-Free Birthday Party",
      tag: "Birthday",
      date: "08 May, 2024",
    ...
    {
      id: 3,
      title: "5 Tips for a Successful Corporate Event",
      tag: "Corporate",
      date: "02 May, 2024",
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        >
          ...
          <p className="text-[#191c49] font-medium text-[17px] max-w-[650px] mx-auto leading-relaxed">
            Ideas, tips, and trends to help you plan unforgettable events <br className="hidden md:block" /> and create lasting memories.
          </p>
        </motion.div>
