...
export default function OurVision() {
  const visionData = data.categories.Event.sections.OurVision.variants.EventOurVision1;
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          ...
          >
            ...
            <h2 className="text-[32px] md:text-[56px] font-bold text-[#0f172a] leading-[1.1] mb-2">
              {visionData.titleStart} <br className="hidden md:block" />
              {visionData.titleMid}
            </h2>
